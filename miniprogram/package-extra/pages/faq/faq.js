...
const FALLBACK_FAQS = {
  ...
  '联系客服': [
    { question: '如何联系人工客服？', answer: '底栏「客服」或首页「联系方式」进入选择页，再选售前（选购报价）或售后（维修质保）。', videoUrl: '' },
...
Page({
  ...
  openTroubleshoot() {
    wx.navigateTo({
      url: '/package-extra/pages/troubleshoot/troubleshoot'
    });
  },
  ...
  openTroubleshootAdmin() {
    ...
    wx.navigateTo({
      url: '/package-extra/pages/troubleshoot-admin/troubleshoot-admin'
    });
  },
